...
// Width for items: nhỏ hơn một chút để không bị phình trên màn lớn,
// và có maxWidth để giữ kích thước hợp lý trên tablet/desktop.
const GAP_ITEM_WIDTH = COLUMNS === 3 ? "30%" : "46%";
...
const styles = StyleSheet.create({
  ...
  item: {
    ...
    // Giới hạn chiều rộng để item không phình quá lớn trên màn rộng
    maxWidth: 220,
  },
  coverWrap: {
